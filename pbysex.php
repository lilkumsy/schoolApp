     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           <h2>View Student By Sex/Gender</h2>
           <ol class="breadcrumb">
            <li><a href="#">Home</a></li>            
            <li class="active">View Student By Sex/Gender</li>
          </ol>
         </div>
       </div>
     </div>
     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-gallery-area">
          <!-- start title -->
          <div class="mu-title">
            <h2>VIEW STUDENT RECORD BY SEX/GENDER</h2>
            <p></p>
          </div>
          <!-- end title -->
       ...
       <center><table  border="">		
           <tr bgcolor="">
			...
			$gender=$_POST['gender'];
            $query="SELECT * FROM studreg where gender='$gender'";
